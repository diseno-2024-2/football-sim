...
class Player(ABC):
    ...
    def __init__(self, name: str, number: int, field: Field, time: float, coordinates=Coordinates()):
        ...
        self.wingspan = 1.7
        self.action_area: Polygon = Polygon(
    ...
    def move_random(self):
        ...
        while esta_Fuera:
            ...
            player_area_new_position: Polygon = Polygon(
    ...
    def behavior(self):
        if self.doing_something is not None:
...
class Movement():
    ...
    def move(self):
        ...
        print("Current Direction: ", self.current_direction,
              " -> norma = ", self.destination_distance)
